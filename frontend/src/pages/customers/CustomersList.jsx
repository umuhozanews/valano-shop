      ...
      <Modal open={showModal} onClose={() => setShowModal(false)} title={t("add")}
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <select value={form.type} onChange={e=>setForm(f=>({...f,type:e.target.value}))} className="w-full h-9 px-3 border border-border rounded-card text-[11px] bg-surface focus:outline-none focus:ring-2 focus:ring-primary">
