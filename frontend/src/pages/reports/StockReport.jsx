...
export default function StockReport() {
  ...
  return (
      ...
      action={
        <div className="flex gap-2">
          <button onClick={generate}
            className="px-3 py-2 border border-border rounded-[6px] text-[11px] text-text-primary hover:bg-background">
            Refresh
          </button>
          {data && (
    ...
    >
      ...
      <Card>
        {loading ? (
          <div className="py-12 text-center text-[11px] text-text-secondary">Loading stock report…</div>
        ) : !rows.length ? (
          <div className="py-12 text-center text-[11px] text-text-secondary">No stock items found</div>
        ) : (
            ...
            <table className="w-full text-[11px]">
              ...
              <tfoot>
                <tr className="border-t-2 border-border">
                  <td colSpan={7} className="pt-2 font-bold text-text-primary text-[11px]">TOTAL</td>
