        ...
        <Card title="New Purchase Order" className="mb-4">
          <form onSubmit={handleCreate} className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="sm:col-span-3 flex gap-2 justify-end">
              ...
              <button type="submit"
                className="px-4 py-2 bg-primary text-white rounded-[6px] text-[11px] font-medium">Create Order</button>
            </div>
          </form>
        </Card>
      )}
      ...
      <Card>
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-[11px] text-text-secondary mt-1">Create an order to start tracking stock from suppliers</p>
          </div>
        ) : (
            ...
            {orders.map(o => (
              <div key={o.id} className="flex items-center justify-between py-3 px-1">
                <div className="min-w-0">
                  <p className="text-[11px] font-medium text-text-primary">{o.supplier_name || `Supplier #${o.supplier_id}`}</p>
