      ...
      <div className="flex gap-5 mt-1">
        {[["#EF4444","0–39"],["#F59E0B","40–64"],["#10B981","65–100"]].map(([c,r]) => (
          <div key={r} className="flex items-center gap-1.5">
            ...
            <span className="text-[13px] text-gray-500">{r}</span>
          </div>
        ))}
      </div>
    </div>
  ...
  if (error) return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="text-center">
        ...
        <h2 className="text-[20px] font-bold text-gray-900 mb-2">Advisory Link Error</h2>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2 mb-3">
            ...
            <span className="text-[17px] font-bold text-gray-900">Inzira Insights</span>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 mb-4">
          <h2 className="text-[15px] font-semibold text-gray-700 mb-2 text-center">Business Health Score</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            {positive.length > 0 && (
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
                <h3 className="text-[14px] font-semibold text-gray-700 mb-3">Positive Factors</h3>
            ...
            {negative.length > 0 && (
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
                <h3 className="text-[14px] font-semibold text-gray-700 mb-3">Areas to Improve</h3>
                <div className="space-y-2">
                  {negative.map((f, i) => (
        ...
        {recs.length > 0 && (
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 mb-4">
            <h3 className="text-[14px] font-semibold text-gray-700 mb-3">Recommendations</h3>
            <div className="space-y-2">
              {recs.map((rec, i) => (
