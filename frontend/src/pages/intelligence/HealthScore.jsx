    ...
    <PageWrapper
      ...
      action={
        <button onClick={runScore} disabled={scoring}
          className="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-[6px] text-[11px] font-medium hover:bg-primary/90 disabled:opacity-60">
    ...
    >
      {loading ? (
        ...
        <Card className="text-center py-16">
          ...
          <h3 className="text-[12px] font-bold text-text-primary mb-2">No Score Yet</h3>
          <p className="text-[11px] text-text-secondary max-w-md mx-auto mb-6">
          ...
          <button onClick={runScore} disabled={scoring}
            className="px-6 py-2.5 bg-primary text-white rounded-[6px] text-[11px] font-medium hover:bg-primary/90 disabled:opacity-60">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <Card title="12-Month Score Trend">
              {chartData.length < 2 ? (
                <div className="h-48 flex items-center justify-center text-[11px] text-text-secondary">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Card title="Positive Factors">
                {positive.length ? (
                  ...
                  <p className="text-[11px] text-text-secondary py-4 text-center">No positive factors identified yet</p>
                )}
              </Card>
              ...
              <Card title="Negative Factors">
                {negative.length ? (
                  ...
                  <p className="text-[11px] text-text-secondary py-4 text-center">No negative factors found</p>
                )}
              </Card>
            </div>
          </div>
