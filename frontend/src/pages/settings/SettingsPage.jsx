                ...
                return (
                  <button key={s.key} onClick={() => setActiveSection(s.key)}
                    ...
                    <div className="min-w-0">
                      <p className={`text-[11px] font-semibold ${activeSection === s.key ? "text-primary" : "text-text-primary"}`}>{s.label}</p>
              ...
              {activeSection === "business" && (
                <Card title="Business Information" subtitle="Update your shop name, location, and sector">
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    {/* Sector */}
                    <div>
                      <label className="block text-[11px] font-medium text-text-primary mb-1">Sector</label>
                    ...
                    {/* District */}
                    <div>
                      <label className="block text-[11px] font-medium text-text-primary mb-1">District</label>
                    ...
                    <div className="col-span-2">
                      <label className="block text-[11px] font-medium text-text-primary mb-1">Invoice Footer Text</label>
                      <textarea value={business.footer}
                        onChange={e => setBusiness(b => ({ ...b, footer: e.target.value }))} rows={2}
                        className="w-full p-2 border border-border rounded-[6px] text-[11px] bg-surface focus:outline-none focus:ring-1 focus:ring-primary" />
                    </div>
                  </div>
                  ...
                  <div className="mb-4 p-3 bg-background rounded-[6px] border border-border flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-[11px] font-medium text-text-primary">Interface Language</p>
                  ...
                  <Card title="Data Usage Consent"
                    ...
                    <div className="space-y-4">
                      <label className="flex items-start gap-4 p-4 border border-border rounded-[8px] cursor-pointer hover:bg-background">
                        ...
                        <div>
                          <p className="text-[11px] font-medium text-text-primary">Allow Health Score Calculation</p>
                      ...
                      <label className="flex items-start gap-4 p-4 border border-border rounded-[8px] cursor-pointer hover:bg-background">
                        <input type="checkbox" checked={consent.lender_sharing}
                          ...
                          className="mt-0.5 h-4 w-4 accent-primary" />
                        <div>
                          <p className="text-[11px] font-medium text-text-primary">Share Score with Lenders</p>
                          <p className="text-[12px] text-text-secondary mt-0.5">
                    ...
                    {ROLE_DEFS.map(r => {
                      ...
                      return (
                        <div key={r.role} className="p-4 border border-border rounded-[8px]">
                          ...
                          <p className="text-[11px] text-text-secondary mb-3">{r.desc}</p>
                          {modules.length > 0 && (
