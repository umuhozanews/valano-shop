        ...
        <div className="flex h-screen items-center justify-center bg-background flex-col gap-4 p-8 text-center">
          ...
          <div className="flex gap-2 mt-2">
            <button
              ...
              className="px-4 py-2 border border-border text-text-primary rounded-btn text-[13px] font-medium"
            >
              Reload
            </button>
            <button
              onClick={this.handleReset}
              className="px-4 py-2 bg-primary text-white rounded-btn text-[13px] font-medium"
            >
              Go to Login
            </button>
          </div>
