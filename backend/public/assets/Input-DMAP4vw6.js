import{j as e}from"./index-VSPncPIY.js";function n({label:a,placeholder:x,icon:s,error:t,hint:r,className:d="",...l}){return e.jsxs("div",{className:"flex flex-col gap-1",children:[a&&e.jsx("label",{className:"text-[14px] font-medium text-text-primary",children:a}),e.jsxs("div",{className:"relative",children:[s&&e.jsx("span",{className:"absolute left-3 top-1/2 -translate-y-1/2 text-text-secondary",children:e.jsx(s,{size:15})}),e.jsx("input",{placeholder:x,className:`
